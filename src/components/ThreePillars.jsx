...
const ThreePillars = () => {
  return (
    <div id="three-pillars" className="w-full relative pt-10">
      {/* ── Section Heading ── */}
      <div className="sticky top-[10vh] z-50 bg-[#0a0f16] py-4">
        <p style={{
      ...
      <div className="flex flex-col gap-[40vh] relative mt-8 w-full">
        {/* CARD 1 — VC */}
        <div
          className="gc gc1 sticky top-[25vh] z-10 bg-[#0a0f16]/85 backdrop-blur-2xl border-t border-white/10 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] w-full h-[55vh] rounded-3xl relative"
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', height: '100%' }}>
            ...
            {/* Right image panel */}
            <div style={{ position: 'relative', overflow: 'hidden', borderRadius: '0 24px 24px 0' }}>
              <img
        ...
        <div
          className="gc gc2 sticky top-[30vh] z-20 bg-[#0a0f16]/85 backdrop-blur-2xl border-t border-white/10 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] w-full h-[55vh] rounded-3xl relative"
        >
        ...
        {/* CARD 3 — AI Tools */}
        <div
          className="gc gc3 sticky top-[35vh] z-30 bg-[#0a0f16]/85 backdrop-blur-2xl border-t border-white/10 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] w-full h-[55vh] rounded-3xl relative overflow-hidden"
        >
